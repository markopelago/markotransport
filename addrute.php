<div class="row">
  INPUT RUTE ARMADA <?php $idd=$_GET['id'];$sss=mysqli_fetch_array(mysqli_query($db,"SELECT * FROM data_armada where id=$idd" )); echo $sss[nama]; ?>
...
<datalist id="cityname">
  <?php  $slctasal=mysqli_query($db,"SELECT * FROM kabupaten"); while ($dtt=mysqli_fetch_array($slctasal)) {
    ?>
